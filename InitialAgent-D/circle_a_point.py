...
async def circle_a_point(radius: float = 10, x_center: float = 0, y_center: float = 0, altitude: float = 5):
    drone = System()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        try:
            ...
            print("Invalid radius value. Using default radius of 10 meters.")
    if len(sys.argv) > 2:
        try:
